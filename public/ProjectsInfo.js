export const projectInfo = [
  ...
  },
  {
    ...
    long_blurb: ["I built my personal website as a platform to showcase my projects, technical skills, and interests in software development and machine learning. The site is deployed on Vercel and developed using Next.js, allowing for a smooth, interactive experience. It serves as both a portfolio and a space for experimentation, where I integrate new technologies and features as I refine my web development skills.",
      "Beyond just showcasing my work, my website acts as a testing ground for learning new frameworks and tools. I’ve structured it in a way that makes future expansion easy, whether that’s implementing a blog, adding interactive project demos"],
  ...
  {
    id: 6,
    title: "Python Redis Queue Clone",
    short_blurb: "Clone of redisqueue that is built on FastAPI with Python for queuing tasks with long runtimes to run sequentially to automate execution of long runtime data pipeline steps and model training",
    link: "https://github.com/c3hodgins/process_queue.git",
    languages: ["Python",],
    long_blurb: ["This project was inspired by running long term workflows such as dataset generation, dense image processing tasks, network training and statistical testing for research. It works by letting you push tasks to a task FIFO that executes tasks sequentially from the cli, without having to use a task scheduler. It uses a singly linked list to implement this queue allowing post requests to its port for pushing tasks to the queue.",
